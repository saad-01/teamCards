...
class MyGuestRidesPage extends StatefulWidget {
  const MyGuestRidesPage({super.key});

  @override
  MyGuestRidesPageState createState() => MyGuestRidesPageState();
}

class MyGuestRidesPageState extends State<MyGuestRidesPage> {
  bool _loading = true;
  bool showAds = true;
  double xOffset = 0;
  double yOffset = 0;
